...
- [通配选择器](#_1-1-通配选择器)
- [类型选择器](#_1-2-类型选择器-e)
- [ID 选择器](#_1-3-id-选择器-e-id)
- [类选择器](#_1-4-类选择器-e-class)
...
- [包含选择器](#_2-1-包含选择器-e-f)
- [子选择器](#_2-2-子选择器-e-f)
- [相邻选择器](#_2-3-相邻选择器-e-f)
- [兄弟选择器](#_2-4-兄弟选择器-e-f)
...
- [简单属性选择器(`E[att]`)](#_3-1-简单属性选择器-e-att)
- [精准属性值选择器(`E[att="val"]`)](#_3-2-精准属性值选择器-e-att-val)
- [匹配部分属性值选择器(`E[att*="val"]`)](#_3-3-匹配部分属性值选择器-e-att-val)
- [匹配属性值开头的选择器(`E[att^="val"]`)](#_3-4-匹配属性值开头的选择器-e-att-val)
- [匹配属性值结尾的选择器(`E[att$="val"]`)](#_3-5-匹配属性值结尾的选择器-e-att-val)
- [自定义属性选择器(`E[att|="val"]`)](#_3-6-自定义属性选择器-e-att-val)
- [匹配带有空格属性的值(`E[att~="val"]`)](#_3-7-匹配带有空格属性的值-e-att-val)
...
- [选中状态选择器](#_4-1-选中状态选择器)
- [鼠标悬停状态选择器](#_4-2-鼠标悬停状态选择器)
- [否定伪类选择器](#_4-3-否定伪类选择器)
- [选择每第 n 个元素选择器](#_4-4-选择每第-n-个元素选择器)
- [从后往前计算选择每第 n 个元素选择器](#_4-5-从后往前计算选择每第-n-个元素选择器)
- [选择每第 n 个某种元素选择器](#_4-6-选择每第-n-个某种元素选择器)
- [从后往前计算选择每第 n 个某种元素选择器](#_4-7-从后往前计算选择每第-n-个某种元素选择器)
- [第一个子元素选择器](#_4-8-第一个子元素选择器)
- [最后一个子元素选择器](#_4-9-最后一个子元素选择器)
- [选择唯一的子元素](#_4-10-选择唯一的子元素)
- [匹配父元素里没有邻近兄弟元素的选择器](#_4-11-匹配父元素里没有邻近兄弟元素的选择器)
- [选择该类型的第一个元素选择器](#_4-12-选择该类型的第一个元素选择器)
...
- [伪元素选择器](#_5-1-伪元素选择器)
- [后置内容元素选择器](#_5-2-后置内容元素选择器-e-after-e-after)
- [前置内容元素选择器](#_5-3-前置内容元素选择器-e-before-e-before)
- [伪元素选择器](#_5-4-伪元素选择器-e-selection)
