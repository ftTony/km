...
- [Linux特点](#一、linux特点)
- [Linux系统组成](#二、linux系统组成)
- [Linux内核主要功能](#三、linux内核主要功能)
- [常见Shell程序](#四、常见shell程序)
- [Linux基本命令](#五、linux基本命令)
...
- `cd`切换当前目录至`dirName`
- `pwd`查看“当前工作目录”的完整路径
- `mkdir`在指定位置创建以DirName(指定的文件名)命名的文件夹或目录。
...
- `more`查看文件里的内容。
- `less`less与 more 类似，但使用 less 可以随意浏览文件
