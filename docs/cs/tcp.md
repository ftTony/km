...
- [TCP](#一、tcp)
- [UDP](#二、udp)
- [TCP 与 UDP 区别](#三、tcp-与-udp-区别)

### 一、TCP

- [TCP 首部格式](#_1-1-tcp-首部格式)
- [三次握手](#_1-2-三次握手)
- [为什么-tcp-连接需要三次握手，两次不可以吗，为什么](#_1-3-为什么-tcp-连接需要三次握手，两次不可以吗，为什么)
- [四次挥手](#_1-4-四次挥手)
- [四次挥手的原因](#_1-5-四次挥手的原因)
- [如何保证可靠传输](#_1-6-如何保证可靠传输)
- [TCP 连接状态](#_1-7-tcp-连接状态)
- [TCP 滑动窗口](#_1-8-tcp-滑动窗口)
- [TCP 流量控制](#_1-9-tcp-流量控制)
- [TCP 拥塞处理](#_1-10-tcp-拥塞处理)
- [如何区分流量控制和拥塞控制](#_1-11-如何区分流量控制和拥塞控制)
...
- [「多图警告」重学 TCP/IP 协议](https://mp.weixin.qq.com/s/pFlJglicKZVh31EOMe83Hw)
...
- [【TCP 协议】(2)---TCP 三次握手和四次挥手](https://www.cnblogs.com/qdhxhz/p/8470997.html)
- [什么是三次握手，这张思维导图让面试官直接给出 offer](https://mp.weixin.qq.com/s/gDa0cBRCKv2BAK8LF2FZCA)
